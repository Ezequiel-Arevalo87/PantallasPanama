...
type Row = {
  ...
  nombre: string;
  periodos: string;
  valor: number;      // original (por si se requiere)
  valorInt: number;   // 👈 entero seguro para mostrar/ordenar/filtrar
...
const rawRows: RawRow[] = [
  ...
  { id: 3,  categoria: "Fiscalización Masiva", ruc: "RUC-100200",  nombre: "Panamá Retail S.A.",         periodos: "04/25", valor: 2980000 },
  { id: 4,  categoria: "Fiscalización Masiva", ruc: "RUC-100201",  nombre: "Construcciones Istmo S.A.",  periodos: "03/25", valor: 1745320 },
  { id: 5,  categoria: "Fiscalización Masiva", ruc: "RUC-100202",  nombre: "Servicios Canal S.A.",       periodos: "02/25", valor: 695 },
  { id: 6,  categoria: "Fiscalización Masiva", ruc: "RUC-100203",  nombre: "Agroexport Delta",           periodos: "01/25", valor: 1100000 },
  { id: 7,  categoria: "Fiscalización Masiva", ruc: "RUC-100204",  nombre: "Tecno Sur S.A.",             periodos: "12/24", valor: 8547 },
  { id: 8,  categoria: "Fiscalización Masiva", ruc: "RUC-100205",  nombre: "Transporte Caribe",          periodos: "11/24", valor: 2300000 },
  { id: 9,  categoria: "Fiscalización Masiva", ruc: "RUC-100206",  nombre: "Hoteles del Istmo",          periodos: "10/24", valor: 978 },
  { id:10,  categoria: "Fiscalización Masiva", ruc: "RUC-100207",  nombre: "Textiles del Istmo",         periodos: "09/24", valor: 1505000 },

  { id:11,  categoria: "Grandes Contribuyentes", ruc: "RUC-200300", nombre: "Comercial ABC S.A.",        periodos: "06/25", valor: 654 },
  { id:12,  categoria: "Grandes Contribuyentes", ruc: "RUC-200301", nombre: "Energía Nacional S.A.",     periodos: "05/25", valor: 4123000.21 },
  { id:13,  categoria: "Grandes Contribuyentes", ruc: "RUC-200302", nombre: "Telecom Panavisión",        periodos: "04/25", valor: 158 },
  { id:14,  categoria: "Grandes Contribuyentes", ruc: "RUC-200303", nombre: "Aviación del Istmo",        periodos: "03/25", valor: 2060000.45 },
  { id:15,  categoria: "Grandes Contribuyentes", ruc: "RUC-200304", nombre: "Finanzas Canal Group",      periodos: "02/25", valor: 657 },
  { id:16,  categoria: "Grandes Contribuyentes", ruc: "RUC-200305", nombre: "Minería del Pacífico",      periodos: "01/25", valor: 3100450.23 },
  { id:17,  categoria: "Grandes Contribuyentes", ruc: "RUC-200306", nombre: "Alimentos Global S.A.",     periodos: "12/24", valor: 236 },
  { id:18,  categoria: "Grandes Contribuyentes", ruc: "RUC-200307", nombre: "Logística Intermodal",      periodos: "11/24", valor: 1299000 },
  { id:19,  categoria: "Grandes Contribuyentes", ruc: "RUC-200308", nombre: "Farmacéutica Panamericana", periodos: "10/24", valor: 2365 },
  { id:20,  categoria: "Grandes Contribuyentes", ruc: "RUC-200309", nombre: "Seguros del Istmo",         periodos: "09/24", valor: 1080000 },

  { id:21,  categoria: "Auditoría Sectorial", ruc: "RUC-300400", nombre: "Servicios XYZ",               periodos: "06/25", valor: 158 },
  { id:22,  categoria: "Auditoría Sectorial", ruc: "RUC-300401", nombre: "AgroPanamá Ltda.",            periodos: "05/25", valor: 1025 },
  { id:23,  categoria: "Auditoría Sectorial", ruc: "RUC-300402", nombre: "Turismo & Viajes S.A.",       periodos: "04/25", valor: 1350000 },
  { id:24,  categoria: "Auditoría Sectorial", ruc: "RUC-300403", nombre: "Educación Privada del Sur",   periodos: "03/25", valor: 2450000 },
  { id:25,  categoria: "Auditoría Sectorial", ruc: "RUC-300404", nombre: "Salud Integral S.A.",         periodos: "02/25", valor: 695 },
  { id:26,  categoria: "Auditoría Sectorial", ruc: "RUC-300405", nombre: "Tecnología Andina",           periodos: "01/25", valor: 1789000 },
  { id:27,  categoria: "Auditoría Sectorial", ruc: "RUC-300406", nombre: "Arquitectura Moderna",        periodos: "12/24", valor: 320 },
  { id:28,  categoria: "Auditoría Sectorial", ruc: "RUC-300407", nombre: "Transporte Urbano S.A.",      periodos: "11/24", valor: 1250000 },
  { id:29,  categoria: "Auditoría Sectorial", ruc: "RUC-300408", nombre: "Comercial Marítima",          periodos: "10/24", valor: 236 },
  { id:30,  categoria: "Auditoría Sectorial", ruc: "RUC-300409", nombre: "Consultores del Istmo",       periodos: "09/24", valor: 2110000 },
];

/* ============ Normalización: valorInt entero seguro ============ */
const BASE_ROWS: Row[] = rawRows.map((r) => ({
  ...
  periodos: r.periodos,
  valor: r.valor,
  valorInt: toInt(r.valor),   // 👈 fijo aquí
}));
...
function buildBreakdown(row: Row) {
  const total = row.valorInt || 0; // 👈 usa el entero
  if (!total) {
...
export default function PriorizacionForm({
  ...
  const rows = React.useMemo<Row[]>(() => {
    ...
    if (condiciones?.length) {
      base = base.filter((r) =>
        condiciones.every((c) => evalCond(r.valorInt, c.operador, c.valorBalboas))
      );
    }
  ...
  const [columnVisibilityModel, setColumnVisibilityModel] =
    React.useState<GridColumnVisibilityModel>({
      categoria: true, ruc: true, nombre: true, periodos: true, valorInt: true,
    });
    ...
    },
 {
  ...
  // El grid ordena con número real
  valueGetter: (params:any) => Number(params.row?.valorInt) ?? 0,

  // Pintamos nosotros, evitando strings como "1.250.000"
  renderCell: (params) => {
    const num = typeof params.row?.valorInt === "number"
      ? params.row.valorInt
      : Number(params.row?.valorInt) || 0;

    return new Intl.NumberFormat("en-US", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2,
    }).format(num); // => 1,000,000.00
  },

  // Orden correcto por número
