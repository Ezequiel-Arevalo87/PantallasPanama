...
import { LiquidacionesAdicionalesForm } from './LiquidacionesAdicionalesForm';

export const LiquidacionesAdicionales = () => {
    ...
    return (
        <Box>
            ...
            {mostrarResultados && <LiquidacionesAdicionalesForm />}
