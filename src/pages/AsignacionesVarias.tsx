...
export const AsignacionesVarias: React.FC<Props> = ({ tipo }) => {
  ...
  const opcionesPrograma: Record<string, string[]> = {
    ...
    omiso: ['omisos vs compras', 'omisos vs dividendos', 'omisos vs 431', 'omisos vs renta', 'omisos vs ITBMS'],
    inexacto: ['ingresos ITBMS vs Ingresos Renta', 'compras ITBMS vs compras', 'gastos vs compras'],
    ...
    <Box>
      <Grid container spacing={2}>
        <Grid item xs={12} sm={3}>
          <TextField select fullWidth label="Red" name="red" value={formData.red} onChange={handleChange}>
        ...
        <Grid item xs={12} sm={3}>
          <TextField label="RUC" name="ruc" value={formData.ruc} onChange={handleChange} fullWidth />
        </Grid>
      ...
      {mostrarResultados && <DetallesAsignacionVarias tipo={tipo} />}
    </Box>
  );
};
