...
import { FormularioImpuestos } from './FormularioImpuestos';

export const PresentacionVoluntaria = () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
     ...
     const programas: string[] = opcionesPrograma[formData.estado] || []; 
    ...
    return (
        <Box>
            ...
            {mostrarResultados && <FormularioImpuestos />}
